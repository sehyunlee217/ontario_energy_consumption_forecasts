...
$$
Utilizing the forecasts generated for temperatures($$x_{temperature}$$), we can generate forecasts for the monthly energy consumptions($$y_{t}$$) using this dynamic regression model as below. 
